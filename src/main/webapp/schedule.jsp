    ...
    <div class="container">
        <div class="top-bar">
            ...
            <div class="nav-left">
                ...
                <a href="scheduleQuery.jsp">出诊查询</a>
...
<div class="main-content">
    <div class="schedule-section">
        ...
        <div class="filter-bar">
            <form action="${pageContext.request.contextPath}/manager/schedule.do" method="get">
                <input type="hidden" name="action" value="list">
                <select name="departmentId">
                    <option value="">所有科室</option>
                    <c:forEach items="${departmentsList}" var="dep1">
                        <optgroup label="${dep1.departmentName}">
                            <c:forEach items="${dep1.childList}" var="dep2">
                                <option value="${dep2.departmentId}" ${selectedDepartmentId == dep2.departmentId ? 'selected' : ''}>
                                        ${dep2.departmentName}
                                </option>
                            </c:forEach>
                        </optgroup>
        ...
        <div class="pagination">
            <c:if test="${pageInfo.pages > 1}">
                <a href="?action=list&page=1&departmentId=${selectedDepartmentId}&date=${selectedDate}" class="${pageInfo.pageNum == 1 ? 'disabled' : ''}">首页</a>
                <a href="?action=list&page=${pageInfo.pageNum - 1}&departmentId=${selectedDepartmentId}&date=${selectedDate}" class="${pageInfo.pageNum == 1 ? 'disabled' : ''}">上一页</a>
                <c:forEach begin="1" end="${pageInfo.pages}" var="i">
                    <a href="?action=list&page=${i}&departmentId=${selectedDepartmentId}&date=${selectedDate}" class="${pageInfo.pageNum == i ? 'active' : ''}">${i}</a>
                </c:forEach>
                <a href="?action=list&page=${pageInfo.pageNum + 1}&departmentId=${selectedDepartmentId}&date=${selectedDate}" class="${pageInfo.pageNum == pageInfo.pages ? 'disabled' : ''}">下一页</a>
                <a href="?action=list&page=${pageInfo.pages}&departmentId=${selectedDepartmentId}&date=${selectedDate}" class="${pageInfo.pageNum == pageInfo.pages ? 'disabled' : ''}">尾页</a>
            </c:if>
...
<div class="side-button-column">
    ...
    <a href="scheduleQuery.jsp" class="side-button text-button" data-text="门诊\n出诊" data-index="1">
