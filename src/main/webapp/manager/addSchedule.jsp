...
<div class="panel admin-panel" style="max-width:600px;margin:30px auto;">
    <div class="panel-head"><strong>新增排班</strong></div>
    <div class="body-content">
        <form method="post" class="form-x" action="${pageContext.request.contextPath}/manager/schedule.do?action=save">
                ...
                <div class="field">
                    <select name="departmentId" class="input" required>
                        ...
                        <c:forEach items="${departmentsList}" var="dep1">
                            <option value="${dep1.departmentId}">${dep1.departmentName}</option>
                            <c:forEach items="${dep1.childList}" var="dep2">
                                <option value="${dep2.departmentId}">&nbsp;&nbsp;${dep2.departmentName}</option>
                            </c:forEach>
                        </c:forEach>
                    </select>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="field"><input type="date" class="input" name="date" required /></div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="field"><input type="number" class="input" name="sumCount" required /></div>
            </div>
            <div class="form-group">
                <div class="label"><label>已挂号数：</label></div>
                <div class="field"><input type="number" class="input" name="visitCount" value="0" required /></div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="field"><input type="text" class="input" name="remarks" /></div>
            </div>
            <div class="form-group">
                <div class="label"></div>
                <div class="field">
