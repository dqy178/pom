...
<head>
    ...
    <style>
        ...
        .content th:nth-child(6), .content td:nth-child(6) {
            width: 43%;
        }
        .pagelist {
            text-align: center;
        ...
        <div class="layout">
            <aside class="sidebar-rect">
                ...
                <ul class="sidebar-list-rect">
                    ...
                    <li><a href="doctorInfo.do" class="active">医生信息</a></li>
                </ul>
            </aside>
            <section class="content">
                ...
                <table>
                    ...
                    <tbody>
                    <c:forEach items="${pageInfo.list}" var="doctor" varStatus="loop">
                        <tr>
                            <td>${loop.index + 1}</td>
                            <td><img src="${pageContext.request.contextPath}/${doctor.avatar}" alt="${doctor.name}" style="width: 80px;"></td>
                            <td>${doctor.name}</td>
                ...
                <div class="pagelist">
                    <c:forEach begin="1" end="${pageInfo.pages}" var="i">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a href="${pageContext.request.contextPath}/doctorInfo.do?page=${i}">${i}</a>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                </div>
